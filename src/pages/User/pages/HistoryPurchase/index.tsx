...
export default function HistoryPurchase() {
  ...
  const buyNow = async (buyCount: number, product_id: number) => {
              ...
              >
                ...
                <div className='mt-6 flex items-end justify-between md:items-center'>
                  <div className='flex items-center'>
                    ...
                    <span className=''>{new Date(purchase.created_at).toLocaleString('vi-VN')}</span>
                  </div>
                  <div className='flex flex-col items-end'>
                    ...
                    <Button
                      ...
                      onClick={() => buyNow(purchase.buy_count, Number(purchase.product.id))}
                    >
