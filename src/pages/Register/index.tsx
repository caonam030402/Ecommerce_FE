...
type FormData = Pick<Schema, 'email' | 'password' | 'confirm_password' | 'username'> // Pick the fields from Schema type which are required
const registerSchema = schema.pick(['username', 'email', 'password', 'confirm_password']) // Create a new schema with only picked fields
...
export default function Register() {
  ...
  const registerAccountMutation = useMutation({
    mutationFn: (body: Omit<FormData, 'confirm_password'>) =>
      authApi.registerAccount({ email: body.email, name: body.username, password: body.password })
  })
